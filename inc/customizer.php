 ...
 *
 * Can be filtered with {@see 'marki_color_schemes'}.
 *
 ...
 */
function marki_get_color_schemes() {
	/**
	 ...
	 * }
	 */
	return apply_filters( 'marki_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'marki' ),
			'colors' => array(
				'#f1f1f1',
				'#ffffff',
				'#ffffff',
...
if ( ! function_exists( 'marki_get_color_scheme' ) ) :
/**
 ...
 */
function marki_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = marki_get_color_schemes();
...
endif; // marki_get_color_scheme

if ( ! function_exists( 'marki_get_color_scheme_choices' ) ) :
/**
 ...
 */
function marki_get_color_scheme_choices() {
	$color_schemes                = marki_get_color_schemes();
...
endif; // marki_get_color_scheme_choices

if ( ! function_exists( 'marki_sanitize_color_scheme' ) ) :
/**
 ...
 */
function marki_sanitize_color_scheme( $value ) {
	$color_schemes = marki_get_color_scheme_choices();
...
endif; // marki_sanitize_color_scheme
 ...
 */
function marki_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = marki_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = marki_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = marki_get_color_scheme_css( $colors );

	wp_add_inline_style( 'marki-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'marki_color_scheme_css' );
 ...
 * @since Twenty Fifteen 1.0
 */
function marki_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', marki_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'marki_customize_control_js' );
 ...
 * @since Twenty Fifteen 1.0
 */
function marki_customize_preview_js() {
	wp_enqueue_script( 'marki-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'marki_customize_preview_js' );
 ...
 */
function marki_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Fifteen 1.0
 */
function marki_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-marki-color-scheme">
		<?php echo marki_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'marki_color_scheme_css_template' );
